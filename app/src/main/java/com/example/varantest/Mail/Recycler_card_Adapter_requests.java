...
public class Recycler_card_Adapter_requests extends FirestorePagingAdapter<Recycler_item_model_requests, Recycler_card_Adapter_requests.itemviewholder> {


    private single_item_click_interface listener;

    public Recycler_card_Adapter_requests(@NonNull @NotNull FirestorePagingOptions<Recycler_item_model_requests> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull @NotNull itemviewholder holder, int position, @NonNull @NotNull Recycler_item_model_requests model) {
...
//Log.d("R_cycle_loader","Loaded data number" +getItemCount());
    ...
    public itemviewholder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View rview = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_item_model_requests, parent, false);
