...
public class Recycler_Paging_card_Adapter extends FirestorePagingAdapter<Recycler_item_paging_model, Recycler_Paging_card_Adapter.itemviewholder> {


    private single_item_click_interface listener;

    public Recycler_Paging_card_Adapter(@NonNull @NotNull FirestorePagingOptions<Recycler_item_paging_model> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull @NotNull itemviewholder holder, int position, @NonNull @NotNull Recycler_item_paging_model model) {
